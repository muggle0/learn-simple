...
watch com.xxx.xxx.xxx method '{params,returnObj,throwExp}'  'params[0].getName=="xixi"'' 

watch com.xxx.xxx.xxx method '{params,returnObj,throwExp}'  'returnObj.getName=="xixi"' 
```
